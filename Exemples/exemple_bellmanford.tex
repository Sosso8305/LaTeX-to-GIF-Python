...
\begin{document} 
        \begin{tikzpicture} 
            ...
            \node (node 2) [circle,text=white,fill=blue!50,above right of= node 1] {T};
            \node (node 3) [circle,text=white,fill=blue!50,below right of= node 1] {U};
            \node (node 4) [circle,text=white,fill=blue!50,right of= node 3] {V};
            \node (node 5) [circle,text=white,fill=blue!50,right of= node 2] {W};
